...
public class Board : MonoBehaviour
{
    ...
    {
        buildings[(int)position.x, (int)position.z] = Instantiate(building, position, building.transform.rotation);
    }
    ...
    internal void UpdateBuilding(Building building, Vector3 position, int id)
    {
        buildings[(int)position.x, (int)position.z] = Instantiate(building, position, building.transform.rotation);
    }
}
